...
//  nlw-nearby
//
//  Created by Diego Galvão on 12/12/24.
//
...
class DetailsViewController: UIViewController {
    ...
    private let couponStackView: UIStackView = {
        ...
        stackView.backgroundColor = Colors.redLight
...
//            containerView.heightAnchor.constraint(equalTo: contentView.heightAnchor, multiplier: 0.4),
            ...
            divider.topAnchor.constraint(equalTo: infoStackView.bottomAnchor, constant: 12),
            ...
            divider2.topAnchor.constraint(equalTo: regulationLabel.bottomAnchor, constant: 12),
